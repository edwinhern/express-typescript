...
export class OpenAiService {
  ...
  //     const questions: IQuestion[] = functionArgs.questions.map((question: ILocaleSchema) => {
  //       return {
  //         // categoryId: category,
  //         status: "pending",
  ...
  //     await questionService.saveQuestions(questions, category);
  ...
  async generateQuestionsV2(
    ...
    count: number,
    category: string | undefined,
    questionType: "one_choice" | "multiple_choice" | "true_false",
                ...
                questions: {
                  ...
                  items: {
                    ...
                    properties: {
                      ...
                      correct: {
                        type: questionType === "true_false" ? "boolean" : "string",
